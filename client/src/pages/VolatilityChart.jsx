  ...
  return (
    <div style={{
      ...
      <p style={{ color: '#9ca3af', fontSize: '0.8rem', marginTop: '8px' }}>
        Model outputs are used for risk awareness, not direct trading signals.
      </p>


      <p style={{ color: '#9ca3af', fontSize: '0.8rem' }}>
        Lower RMSE indicates better short-horizon volatility estimation.
      </p>
      ...
      <div style={{
        ...
        {chartData ? (
          ...
          <div style={{
            ...
            Run a volatility forecasting model on a selected asset and rolling window.
          </div>
        )}
      </div>
