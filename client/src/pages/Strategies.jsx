...
export default function Strategies() {
  ...
  const sections = [
    ...
    { k: "AI/ML Alpha", d: (
      <>
        <strong>How it works:</strong> Regression and ensemble models trained on market-derived features.
        ...
        <br/><strong>In practice:</strong> Deployed as a Python microservice and integrated into portfolio analytics.
