export default function Risk() {
  const rows = [
    { risk: "Model Overfit", mitigation: "Cross-validation, live gating, rolling retraining" },
    ...
    { risk: "Prediction Uncertainty", mitigation: "Short horizon models, conservative usage" },
  ];
  ...
  return (
    <div className="container">
      ...
      <p className="small" style={{ marginTop: 12 }}>
        ML outputs are used as directional signals, not standalone trading decisions.
      </p>
